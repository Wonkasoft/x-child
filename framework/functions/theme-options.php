						...
						'x_body_font_weight_selection' => array(
							...
							'options'   => array(
								'references' => array(
									array(
										'key'    => 'font_family',
										'source' => 'x_body_font_family_selection',
									),
								),
							),
						),
						...
						'x_headings_font_weight_selection' => array(
							...
							'options'   => array(
								'references' => array(
									array(
										'key'    => 'font_family',
										'source' => 'x_headings_font_family_selection',
									),
								),
							),
						),
				...
				'navbar'              => array(
					...
					'controls'    => array(
						...
						'x_fixed_menu_scroll'  => array(
							...
							'condition' => array(
								'option' => 'x_navbar_positioning',
								'value'  => array( 'fixed-right', 'fixed-left' ),
								'op'     => 'IN',
							),
							'options'   => array(
								'choices' => array(
						...
						'x_logo_font_weight_selection' => array(
							...
							'options'   => array(
								'references' => array(
									array(
										'key'    => 'font_family',
										'source' => 'x_logo_font_family_selection',
									),
								),
							),
						),
						...
						'x_navbar_font_weight_selection' => array(
							...
							'options'   => array(
								'references' => array(
									array(
										'key'    => 'font_family',
										'source' => 'x_navbar_font_family_selection',
									),
								),
							),
						),
