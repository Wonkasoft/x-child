...
function wonkasoft_enqueue_scripts() {

	// Script
	wp_enqueue_script( 'select2-js', 'https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.10/js/select2.min.js', array( 'jquery' ), '4.0.10', true );
	wp_enqueue_script( 'connect-js', get_stylesheet_directory_uri() . '/assets/js/connect.js', array( 'jquery' ), '1.0.0', true );
	wp_enqueue_script( 'wonkamizer-js', get_stylesheet_directory_uri() . '/assets/js/x-child.min.js', array( 'jquery', 'select2-js' ), '1.0.0', true );

}
add_action( 'wp_enqueue_scripts', 'wonkasoft_enqueue_scripts', 100 );

function wonkasoft_x_enqueue_styles( $stack, $ext ) {
	// Style
	wp_enqueue_style( 'select2', 'https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.10/css/select2.min.css', null, time(), 'all' );
	wp_enqueue_style( 'x-child-woocommerce', get_stylesheet_directory_uri() . '/woocommerce.css', null, time(), 'all' );
}
