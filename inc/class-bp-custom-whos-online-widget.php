<?php
/**
 * BuddyPress Custom Members Who's Online Widget.
 *
 * @package BuddyPress
 ...
 * @since 1.0.3
 */
class BP_Custom_Whos_Online_Widget extends WP_Widget {
	...
	public function __construct() {
		$name        = _x( "(BuddyPress) Custom Who's Online", 'widget name', 'buddypress' );
		$description = __( 'Profile photos of online users', 'buddypress' );
		parent::__construct( false, $name, array(
			'description'                 => $description,
			'classname'                   => 'widget_bp_custom_whos_online_widget buddypress widget',
