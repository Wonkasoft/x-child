<?php
/**
 * Template Name: Full Page Conference Hallway 2
 *
 * @package x-child
 * @subpackage x_child
 * @since 1.0.0
...
<iframe height="100%" width="100%"  src="https://rockstarconference.name/b/lou-4jf-aw3" frameborder="0" allowfullscreen></iframe>
